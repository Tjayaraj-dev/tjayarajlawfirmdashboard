    ...
    <div className="mx-auto max-w-3xl px-6 py-10 lg:px-10">
      <header className="mb-8">
        ...
        <p className="mt-3 max-w-xl text-sm text-muted-foreground">
          The vault’s filing taxonomy. Seeded with the six universal defaults —
          edit to match the firm’s convention.
        </p>
      </header>
      <LookupManager table="document_categories" rows={data ?? []} />
    </div>
  )
}
